...
# Initialize spots_status as booleans (False = occupied, True = empty)
...
while ret:
    ...
    if frame_nmr % step == 0 and previous_frame is not None:
        ...
        # Debug print sorted diffs descending
...
occupied_slots = sum(1 for s in spots_status if not s)  # False means occupied
available_slots = sum(1 for s in spots_status if s)     # True means empty
